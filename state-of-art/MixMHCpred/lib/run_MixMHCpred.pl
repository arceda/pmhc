...
#print "finish check allele names\n";
...
##print "finish load information about allele\n";
...
$rd=101;
#$rd=101; # agregue esto xq perl no podia crear directorios
my $tmp_dir=dirname($lib_dir)."${sep}temp$sep$rd";  # comente esto
#print $tmp_dir;
#print "\n";
make_path($tmp_dir); # comente esto
...
#print "finish print input peptides\n";
...
#print "finish run the prediction\n";
...
if ($sys eq "MSWin32" || $sys eq "msys"){    
    ...
    #print "$lib_dir$sep"."MixMHCpred.x $output_file $lib_dir $rd $input $nh @allele_list @allele_list_map @Nmotif_all @shifts_all @shifts_sd_all\n";
    ...
    #print "finish calling MixMHXpred.x"
}
