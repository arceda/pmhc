...
setenv	NMHOME	/home/vicente/projects/pmhc/netMHCpan-4.1

# determine where to store temporary files (must be writable to all users)

if ( ${?TMPDIR} == 0 ) then
	setenv  TMPDIR  /home/vicente/projects/pmhc/netMHCpan-4.1/tmp
endif
...
setenv NetMHCpanWWWPATH /services/NetMHCpan/tmp/
setenv NetMHCpanWWWDIR /usr/opt/www/pub/CBS/services/NetMHCpan/tmp
